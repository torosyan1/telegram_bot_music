                        ...
                        switch (_a.label) {
                            case 0:
                                ...
                                return [4 /*yield*/, fluent_ffmpeg_1.default("/home/vahag/Desktop/telegraf/myvideo.mp4")
                                        ...
                                        .toFormat("mp3")
                                        .saveToFile("/home/vahag/Desktop/telegraf/music/" + newName_1)
                                        .on("end", function () { return __awaiter(void 0, void 0, void 0, function () {
                                        var params;
                                        return __generator(this, function (_a) {
                                            switch (_a.label) {
                                                case 0:
                                                    file_1 = fs_1.readFileSync("/home/vahag/Desktop/telegraf/music/" + newName_1);
                                                    params = {
                                                ...
                                                case 1:
                                                    _a.sent();
                                                    return [4 /*yield*/, fs_1.default.unlink("/home/vahag/Desktop/telegraf/music/" + newName_1, function (err) {
                                                            if (err)
